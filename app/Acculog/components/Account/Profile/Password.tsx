        ...
        <>
            <div className="relative mb-4">
                ...
                <input
                    ...
                    className={`mt-1 block w-full px-4 py-2 pr-10 border-b text-xs text-black ${passwordError ? "border-red-500" : "border-gray-300"
                        }`}
                />
                <button
                    type="button"
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className={`mt-1 block w-full px-4 py-2 border-b text-xs text-black ${confirmError ? "border-red-500" : "border-gray-300"
                        }`}
                />
                <button
                    type="button"
